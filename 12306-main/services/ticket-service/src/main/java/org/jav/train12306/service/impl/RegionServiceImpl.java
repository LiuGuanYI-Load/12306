...
import org.jav.train12306.common.enums.RegionStationQueryTypeEnum;
import org.jav.train12306.dao.entity.RegionDO;
import org.jav.train12306.dao.entity.StationDO;
import org.jav.train12306.dao.mapper.RegionMapper;
import org.jav.train12306.dao.mapper.StationMapper;
...
import org.jav.train12306.framework.starter.common.enums.FlagEnum;
...
public class RegionServiceImpl  implements RegionStationService {
    ...
    * @Author: Jav
    * @Date: 2025/3/16
    * @Description: 列出所有的车站 目前没有这个缓存load 无法查询
    * @Param: []
    * @return: java.util.List<org.jav.train12306.dto.resp.StationQueryRespDTO>
    *
    */
    @Override
    ...
    * @Author: Jav
    * @Date: 2025/3/16
    * @Description: 列出两个地区之间的车站
    * @Param: [org.jav.train12306.dto.req.RegionStationQueryReqDTO]
    * @return: java.util.List<org.jav.train12306.dto.resp.RegionStationQueryRespDTO>
    *
    */
    @Override
    ...
    private List<RegionStationQueryRespDTO> loadAndSet(final String key, CacheLoader<String> loader) {
        ...
        List<RegionStationQueryRespDTO> respDTOList = com.alibaba.fastjson2.JSON.parseArray(result, RegionStationQueryRespDTO.class);
