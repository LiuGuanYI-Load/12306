...
package org.jav.train12306.framework.starter.log.core;
...
import org.jav.train12306.framework.starter.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(org.jav.train12306.framework.starter.log.annotation.ILog) || @annotation(org.jav.train12306.framework.starter.log.annotation.ILog)")
